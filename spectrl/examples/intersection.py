...
if __name__ == '__main__':
    ...
    # Create environment
    env = IntersectionEnv(init_locations[spec_num], max_steps=MAX_STEPS,
                          stay_prob=stay_probs[spec_num])
    ...
    params = HyperParams(max_steps=MAX_STEPS, num_training_steps=NUM_STEPS,
                         ...
                         render=render, ne_epsilon=0.05, num_verify_samples=2000)
    ...
    if render and joint_policy:
        ...
        get_rollout(env, joint_policy, True, stateful_policy=True,
                    max_timesteps=params.horizon)
