...
def dummy_resource_wrapper(predicate):
    '''
    Wraps a state based predicate to a state-resource predicate.
    '''
    def new_predicate(sys_state, res_state):
        return predicate(sys_state)
    return new_predicate
